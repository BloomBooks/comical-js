...
export class Tail {
    ...
    // This is usually present but might not be in the unusual case of the tail
    // being inside the bounds of the bubble.
    pathstroke?: paper.Path;
    // The path representing the space within the tail.
    // Will not be present if the bubble is transparent.
    pathFill?: paper.Path;
