...
export class Bubble {
    ...
    static adjustTowards(origin: Point, target: Point, originSize: Size) {
        // Given the width and height a rectangle centered at origin,
        // find the point on the border of the rectangle closest to target.
